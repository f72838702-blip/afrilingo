      ...
      lessons: [
        {
          ...
          exercises: [
            ...
            },
            {
              ...
              pairs: [
                { left: { nko: "ߌ ߣߌ ߗߋ", latin: "i ni cɛ" }, right: { fr: "Bonjour" } },
                { left: { nko: "ߐ ߣߌ ߗߋ", latin: "ɔ ni cɛ" }, right: { fr: "Et bonjour à toi" } },
                { left: { nko: "ߌ ߣߌ ߛߎ", latin: "i ni su" }, right: { fr: "Bonsoir" } },
                { left: { nko: "ߞߋߣߋ", latin: "kɛnɛ" }, right: { fr: "Ça va" } },
              ],
            },
            {
              id: "e4",
        ...
        },
        {
          ...
          exercises: [
            ...
            },
            {
              ...
              pairs: [
                { left: { nko: "ߌ ߣߌ ߗߋ", latin: "i ni cɛ" }, right: { fr: "Bonjour" } },
                { left: { nko: "ߌ ߣߌ ߕߌߟߍ", latin: "i ni tile" }, right: { fr: "Bon après-midi" } },
                { left: { nko: "ߌ ߣߌ ߛߎ", latin: "i ni su" }, right: { fr: "Bonsoir" } },
                { left: { nko: "ߞߊߣ ߓߋߣ", latin: "k'an bɛn" }, right: { fr: "Au revoir" } },
                { left: { nko: "ߖߋ", latin: "jɛ" }, right: { fr: "Paix" } },
              ],
            },
            {
              id: "e4",
          ...
          exercises: [
            ...
            },
            {
              ...
              pairs: [
                ...
                { left: { nko: "ߞߊߣ ߓߋߣ", latin: "k'an bɛn" }, right: { fr: "Au revoir" } },
                { left: { nko: "ߖߋ", latin: "jɛ" }, right: { fr: "Paix" } },
                { left: { nko: "ߞߍߟߍߣߦߊ", latin: "kelenya" }, right: { fr: "Unité" } },
              ],
            },
          ],
        },
